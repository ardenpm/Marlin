...
#define STRING_CONFIG_H_AUTHOR "(Paul Arden, CR-10S Aero)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CR-10S Aero"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "89ad196a-c6e2-4cbe-90ff-6710b6910fa3"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    // E3D-V6 Volcano with Sock and 1.2mm hardened steel nozzle
    #define DEFAULT_Kp 51.4
    #define DEFAULT_Ki 6.56
    #define DEFAULT_Kd 100.7
  #endif
#endif // PIDTEMP
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 407.77 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 50, 150 }
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (4*125) }
